...
class StandardFormatsSpec extends AnyFlatSpec with Matchers with StandardFormats with BasicFormats {
  ...
  {
    val yaml = YamlArray(YamlNumber(42), YamlNumber(4.2), YamlNumber(3), YamlNumber(4))
  ...
  {
    val yaml =
      YamlArray(YamlNumber(42), YamlNumber(4.2), YamlNumber(3), YamlNumber(4), YamlNumber(5))
  ...
  {
    val yaml = YamlArray(YamlNumber(42),
                         YamlNumber(4.2),
                         YamlNumber(3),
                         YamlNumber(4),
                         YamlNumber(5),
